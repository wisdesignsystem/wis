  ...
  return (
    <div className={styles.row}>
      ...
      <div className={styles.col}>
        ...
        <Toggle variant="ghost" text="Toggle Button" icon={<Icon />} iconControl="suffix" />
      ...
      <div className={styles.col}>
        ...
        <Toggle variant="ghost" disabled text="Toggle Button" icon={<Icon />} iconControl="suffix" />
      ...
      <div className={styles.col}>
        ...
        <Toggle size="sm" text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="sm" icon={<Icon />} />
      </div>
      <div className={styles.col}>
        <Toggle size="sm" disabled text="Toggle Button" />
        <Toggle size="sm" disabled text="Toggle Button" icon={<Icon />} />
        <Toggle size="sm" disabled text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="sm" disabled icon={<Icon />} />
      </div>

      <div className={styles.col}>
        <Toggle size="sm" variant="ghost" text="Toggle Button" />
        <Toggle size="sm" variant="ghost" text="Toggle Button" icon={<Icon />} />
        <Toggle size="sm" variant="ghost" text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="sm" variant="ghost" icon={<Icon />} />
      </div>
      <div className={styles.col}>
        <Toggle size="sm" variant="ghost" disabled text="Toggle Button" />
        <Toggle size="sm" variant="ghost" disabled text="Toggle Button" icon={<Icon />} />
        <Toggle size="sm" variant="ghost" disabled text="Toggle Button" icon={<Icon />} iconControl="suffix" />
      ...
      <div className={styles.col}>
        ...
        <Toggle size="xs" text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="xs" icon={<Icon />} />
      </div>
      <div className={styles.col}>
        <Toggle size="xs" disabled text="Toggle Button" />
        <Toggle size="xs" disabled text="Toggle Button" icon={<Icon />} />
        <Toggle size="xs" disabled text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="xs" disabled icon={<Icon />} />
      </div>

      <div className={styles.col}>
        <Toggle size="xs" variant="ghost" text="Toggle Button" />
        <Toggle size="xs" variant="ghost" text="Toggle Button" icon={<Icon />} />
        <Toggle size="xs" variant="ghost" text="Toggle Button" icon={<Icon />} iconControl="suffix" />
        <Toggle size="xs" variant="ghost" icon={<Icon />} />
      </div>
      <div className={styles.col}>
        <Toggle size="xs" variant="ghost" disabled text="Toggle Button" />
        <Toggle size="xs" variant="ghost" disabled text="Toggle Button" icon={<Icon />} />
        <Toggle size="xs" variant="ghost" disabled text="Toggle Button" icon={<Icon />} iconControl="suffix" />
