...
export default {
	...
	exposes: {
		...
		"./box": {
			...
			mobile: "@/packages/box/mobile/index",
		},
		"./actions": {
			pc: "@/packages/actions/pc/index",
			mobile: "@/packages/actions/mobile/index",
		},
		"./page": {
			pc: "@/packages/page/pc/index",
			mobile: "@/packages/page/mobile/index",
		},
		"./layout": {
			pc: "@/packages/layout/pc/index",
			mobile: "@/packages/layout/mobile/index",
		},
		"./module": {
			pc: "@/packages/module/pc/index",
			mobile: "@/packages/module/mobile/index",
		},
		"./shortcut": {
			pc: "@/packages/shortcut/pc/index",
			mobile: "@/packages/shortcut/mobile/index",
		},
		"./button": {
			pc: "@/packages/button/pc/index",
			mobile: "@/packages/button/mobile/index",
		},
		"./toggle": {
